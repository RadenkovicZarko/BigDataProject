...
public class FederalFundsRateProducer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String apiUrl = "https://www.alphavantage.co/query?function=FEDERAL_FUNDS_RATE&interval=monthly&apikey=" + alphaVantageApiKey;
            ...
            dataArray.forEach(dataEntry -> {
                ...
                ProducerRecord<String, String> record = new ProducerRecord<>("federalFundsRate", date, value);
