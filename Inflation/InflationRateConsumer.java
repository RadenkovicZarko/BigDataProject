...
public class InflationRateConsumer {
    private static final String CSV_FILE = "inflationRateData.csv";
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "InflationRateConsumerGroup");
        properties.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        Consumer<String, String> consumer = new KafkaConsumer<>(properties);

        consumer.subscribe(Collections.singletonList("inflationRate"));
